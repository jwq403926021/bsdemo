export default class SystemController {
  ...
  static doLoginByUaa (sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/login/doLoginByUaa', 'post', params, axiosOption, httpOption);
  }

  static getUaaLoginUrl (sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/login/getUaaLoginUrl', 'get', params, axiosOption, httpOption);
  }

  static getUaaLogoutUrl (sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/login/getUaaLogoutUrl', 'get', params, axiosOption, httpOption);
  }

  static changePasswordByUaa (sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/login/changePasswordByUaa', 'post', params, axiosOption, httpOption);
  }
