### 开源声明
   _**橙单已完整开源全部脚手架代码，包括工作流、在线表单、操作权限和数据过滤权限等组件。其完整性和成熟度明显高于售价几近万元的竞品，而我们则全部源码开放，没有一丝遮蔽。与此同时，我们还会提供令人印象深刻的、完全免费的线上开发文档。**_ 欢迎加入我们的技术支持QQ群2 (883176267)，如果橙单对您确有帮助，Fork 的同时，也请 Star 一下。
> 橙单作为一款低代码生成工具，我们没有为您准备任何可复用的业务模块，如人事、供应商、出入库、订单等，因为这些模块您都可以根据自己的需求，用橙单快速生成。
