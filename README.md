### 重要声明
 **从 2.0 版本开始，橙单正式开源基于 Flowable 6.6 / Activiti 7.x 和在线表单的的工作流功能，前后台代码完整开源，无任何混淆。而此前开源的单体和微服务工程，基础架构代码目前也已全部开源，18 万字的线上文档全部免费。**欢迎加入我们的QQ群(788581363)，或添加作者个人QQ(3510245832) 拉你入群。如果橙单对您确有帮助，Fork 的同时，也请 Star 一下。
