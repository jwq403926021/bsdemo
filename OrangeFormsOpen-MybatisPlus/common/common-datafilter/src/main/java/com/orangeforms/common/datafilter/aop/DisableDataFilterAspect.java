package com.orangeforms.common.datafilter.aop;
...
public class DisableDataFilterAspect {
     ...
     */
    @Pointcut("@within(com.orangeforms.common.core.annotation.DisableDataFilter) " +
            "|| @annotation(com.orangeforms.common.core.annotation.DisableDataFilter)")
