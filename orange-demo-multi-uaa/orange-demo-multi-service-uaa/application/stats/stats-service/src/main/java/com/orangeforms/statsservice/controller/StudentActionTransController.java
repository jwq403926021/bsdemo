package com.orangeforms.statsservice.controller;

import com.github.pagehelper.page.PageMethod;
import com.orangeforms.statsservice.model.*;
import com.orangeforms.statsservice.service.*;
import com.orangeforms.statsapi.dto.*;
import com.orangeforms.statsapi.vo.*;
...
public class StudentActionTransController extends BaseController<StudentActionTrans, StudentActionTransVo, Long> {
    ...
    public ResponseResult<Long> add(@MyRequestBody StudentActionTransDto studentActionTransDto) {
        ...
        // 验证关联Id的数据合法性
        CallResult callResult = studentActionTransService.verifyAllRelatedData(studentActionTrans, null);
    ...
    public ResponseResult<Void> update(@MyRequestBody StudentActionTransDto studentActionTransDto) {
        ...
        // 验证关联Id的数据合法性
        CallResult callResult = studentActionTransService.verifyAllRelatedData(studentActionTrans, originalStudentActionTrans);
        if (!callResult.isSuccess()) {
            return ResponseResult.errorFrom(callResult);
        }
    ...
    public ResponseResult<StudentActionTransVo> saveNewOrUpdate(@RequestBody StudentActionTransDto data) {
        StudentActionTrans studentActionTrans = MyModelUtil.copyTo(data, StudentActionTrans.class);
        service().saveNewOrUpdate(studentActionTrans, studentActionTransService::saveNew, studentActionTransService::update);
        return ResponseResult.success(StudentActionTrans.INSTANCE.fromModel(studentActionTrans));
    }
    ...
    public ResponseResult<Void> saveNewOrUpdateBatch(@RequestBody List<StudentActionTransDto> dataList) {
        List<StudentActionTrans> studentActionTransList = MyModelUtil.copyCollectionTo(dataList, StudentActionTrans.class);
        service().saveNewOrUpdateBatch(studentActionTransList, studentActionTransService::saveNewBatch, studentActionTransService::update);
        return ResponseResult.success();
    }
    ...
    public ResponseResult<Void> verifyRelatedData(@RequestBody StudentActionTransDto data) {
        StudentActionTrans studentActionTrans = MyModelUtil.copyTo(data, StudentActionTrans.class);
        return super.baseVerifyRelatedData(studentActionTrans, StudentActionTrans::getTransId);
    }
    ...
    public ResponseResult<Void> verifyRelatedDataList(@RequestBody List<StudentActionTransDto> dataList) {
        List<StudentActionTrans> studentActionTransList = MyModelUtil.copyCollectionTo(dataList, StudentActionTrans.class);
        return super.baseVerifyRelatedDataList(studentActionTransList, StudentActionTrans::getTransId);
    }
