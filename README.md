### 重要声明
 **从 2.0 版本开始，橙单正式开源基于 Flowable 6.6 / Activiti 7.x 和在线表单的的工作流功能，前后台代码完整开放，无任何混淆。欢迎加入我们的QQ群(788581363)，或添加作者个人QQ(3510245832) 拉你入群。如果确实对您有所帮助，Fork 的同时，也请 Star 一下。
