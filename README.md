...
欢迎加入我们的技术交流群，如遇任何使用中的问题我们都将第一时间为您答疑。**QQ群4 [664800781]**。

### 新架构优势
在升级到 2.8 版本之后，橙单基础架构组件，目前包括报表打印、在线表单和工作流等，全部支持第三方快速接入功能，并以 “**若依**” 为示例，提供了完整且详细的接入文档，其他框架或老系统均可参考该示例文档，手动修改后接入橙单的全部功能组件。具体可见下面的 “**若依**” 接入效果图。
