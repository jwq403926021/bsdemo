...
- 报表打印，统计报表新增支持透视表组件。
- 报表打印，打印模板新增支持边框颜色和边框线条样式。
- 基础架构，全局编码字典支持 show_order。
- 基础架构，基础架构，优化部门层级变更的逻辑，优化后性能与部门层级深度近乎无关。
- 生成器，支持仅生成工程脚手架的功能，该功能会忽略生成业务代码，方便用户进行原始框架的快速搭建。

### 最新通知
> 多租户 + 工作流 + 在线表单，目前所有的商业脚手架均无支持，因为实现难度较大。

- 橙单多租户企业版工程优惠券即将取消，截至日期 2022年8月15日 (**今晚**)，目前价格仅为 339。后面多租户会支持工作流和在线表单，均可免费升级。
