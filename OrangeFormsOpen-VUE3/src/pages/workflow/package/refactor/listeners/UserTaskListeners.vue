    ...
    >
      ...
      >
        ...
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the listener ID',
            trigger: ['blur', 'change'],
          }"
        >
        ...
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the Java class',
            trigger: ['blur', 'change'],
          }"
        >
        ...
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the expression',
            trigger: ['blur', 'change'],
          }"
        >
        ...
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the delegate expression',
            trigger: ['blur', 'change'],
          }"
        >
        ...
        <template v-if="listenerForm.listenerType === 'scriptListener'">
          <el-form-item
            ...
            :rules="{
              required: true,
              trigger: ['blur', 'change'],
              message: 'Please fill in the script format',
            }"
          >
          ...
          <el-form-item
            ...
            :rules="{
              required: true,
              trigger: ['blur', 'change'],
              message: 'Please fill in the script content',
            }"
          >
          ...
          <el-form-item
            ...
            :rules="{
              required: true,
              trigger: ['blur', 'change'],
              message: 'Please fill in the resource address',
            }"
          >
        ...
        <template v-if="listenerForm.event === 'timeout'">
          ...
          <el-form-item
            ...
            :rules="{
              required: true,
              trigger: ['blur', 'change'],
              message: 'Please fill in the timer configuration',
            }"
          >
    ...
    >
      ...
      >
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the field name',
            trigger: ['blur', 'change'],
          }"
        >
        ...
        <el-form-item
          ...
          :rules="{
            required: true,
            message: 'Please fill in the field value',
            trigger: ['blur', 'change'],
          }"
        >
