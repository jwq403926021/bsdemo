...
import com.orangeforms.common.core.annotation.RelationGlobalDict;
...
public class ImportUtil {
    ...
    private static boolean isLogicDeleteColumn(Field field) {
        Column c = field.getAnnotation(Column.class);
        return c != null && c.isLogicDelete();
    }
