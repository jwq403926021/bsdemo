...
public class StudentActionStatsController extends BaseController<StudentActionStats, StudentActionStatsVo, Long> {
    ...
    public ResponseResult<Void> verifyRelatedData(@RequestBody StudentActionStatsDto data) {
        StudentActionStats studentActionStats = MyModelUtil.copyTo(data, StudentActionStats.class);
        return super.baseVerifyRelatedData(studentActionStats, StudentActionStats::getStatsId);
    }
    ...
    public ResponseResult<Void> verifyRelatedDataList(@RequestBody List<StudentActionStatsDto> dataList) {
        List<StudentActionStats> studentActionStatsList = MyModelUtil.copyCollectionTo(dataList, StudentActionStats.class);
        return super.baseVerifyRelatedDataList(studentActionStatsList, StudentActionStats::getStatsId);
    }
