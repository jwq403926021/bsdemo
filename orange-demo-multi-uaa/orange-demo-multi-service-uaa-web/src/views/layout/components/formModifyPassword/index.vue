  ...
  methods: {
    ...
    onSave () {
      this.$refs.formModifyPassword.validate((valid) => {
        ...
        // uaa修改密码
        let isUaaLogin = window.sessionStorage.getItem('isUaaLogin');
        let httpCall = (isUaaLogin === '1') ? SystemController.changePasswordByUaa(this, params) : SystemController.changePassword(this, params);
        httpCall.then(res => {
