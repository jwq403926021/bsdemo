...
import com.orangeforms.statsapi.dto.CourseTransStatsDto;
import com.orangeforms.statsapi.vo.CourseTransStatsVo;
...
public interface CourseTransStatsClient extends BaseClient<CourseTransStatsDto, CourseTransStatsVo, Long> {
     ...
     */
    @Override
    @PostMapping("/courseTransStats/verifyRelatedData")
    ResponseResult<Void> verifyRelatedData(@RequestBody CourseTransStatsDto data);
     ...
     */
    @Override
    @PostMapping("/courseTransStats/verifyRelatedDataList")
    ResponseResult<Void> verifyRelatedDataList(@RequestBody List<CourseTransStatsDto> dataList);
