...
public class CourseTransStatsController extends BaseController<CourseTransStats, CourseTransStatsVo, Long> {
    ...
    public ResponseResult<Void> verifyRelatedData(@RequestBody CourseTransStatsDto data) {
        CourseTransStats courseTransStats = MyModelUtil.copyTo(data, CourseTransStats.class);
        return super.baseVerifyRelatedData(courseTransStats, CourseTransStats::getStatsId);
    }
    ...
    public ResponseResult<Void> verifyRelatedDataList(@RequestBody List<CourseTransStatsDto> dataList) {
        List<CourseTransStats> courseTransStatsList = MyModelUtil.copyCollectionTo(dataList, CourseTransStats.class);
        return super.baseVerifyRelatedDataList(courseTransStatsList, CourseTransStats::getStatsId);
    }
