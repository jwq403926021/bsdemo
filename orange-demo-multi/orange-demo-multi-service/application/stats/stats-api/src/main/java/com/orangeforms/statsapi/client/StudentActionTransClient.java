...
import com.orangeforms.statsapi.dto.StudentActionTransDto;
import com.orangeforms.statsapi.vo.StudentActionTransVo;
...
public interface StudentActionTransClient extends BaseClient<StudentActionTransDto, StudentActionTransVo, Long> {
     ...
     */
    @Override
    @PostMapping("/studentActionTrans/saveNewOrUpdate")
    ResponseResult<StudentActionTransVo> saveNewOrUpdate(@RequestBody StudentActionTransDto data);
     ...
     */
    @Override
    @PostMapping("/studentActionTrans/saveNewOrUpdateBatch")
    ResponseResult<Void> saveNewOrUpdateBatch(@RequestBody List<StudentActionTransDto> dataList);
     ...
     */
    @Override
    @PostMapping("/studentActionTrans/verifyRelatedData")
    ResponseResult<Void> verifyRelatedData(@RequestBody StudentActionTransDto data);
     ...
     */
    @Override
    @PostMapping("/studentActionTrans/verifyRelatedDataList")
    ResponseResult<Void> verifyRelatedDataList(@RequestBody List<StudentActionTransDto> dataList);
     ...
     */
    @Override
    @PostMapping("/studentActionTrans/deleteById")
    ResponseResult<Integer> deleteById(@RequestParam("transId") Long transId);
